    ...
    describe("When I add an image file as bill proof", () => {
      test("Then this new file should have been changed in the input", () => {
        ...
        fireEvent.change(fileInput, {
          target: {
            files: [
              new File(["bill.jpeg"], "bill.jpeg", { type: "image/jpeg" }),
            ],
          },
        });
    ...
    describe("When I create a new bill", () => {
      test("Add bill to mock API POST", async () => {
        ...
        fireEvent.change(inputExpenseName, {
          target: { value: inputData.expense_name },
        });
      ...
      test("Then the file type is checked on change", () => {
        ...
        const badImgMock = new File(["(⌐□_□)"], "file.pdf", {
        ...
        expect(handleChangeFile).toHaveReturnedWith(true);
